...
- `core-data/AppDatabase.kt` — Room v8, migration history, schema exported to `core-data/schemas/`
...
- **Room DB is at version 8.** Migrations live in `AppDatabase.kt`; schema JSON files in `core-data/schemas/`.
