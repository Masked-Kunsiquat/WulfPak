...
- `core-data/AppDatabase.kt` — Room v6, migration history, schema exported to `core-data/schemas/`
...
- **Room DB is at version 6.** Migrations live in `AppDatabase.kt`; schema JSON files in `core-data/schemas/`.
